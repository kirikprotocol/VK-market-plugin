package com.eyelinecom.whoisd.sads2.vk.market.services.db
...
class TestDBServiceFactory {
  ...
  synchronized static DBService createDBService() throws IOException {
    ...
    final DBService db = new DBService(hiberProps, "/com/eyelinecom/whoisd/sads2/vk/market/services/db/hibernate-model-test.cfg.xml")
  ...
  protected static void createEmptyDB(Properties hibernateProperties) {
    ...
    config.configure("/com/eyelinecom/whoisd/sads2/vk/market/model/model.cfg.xml")
    config.configure("/com/eyelinecom/whoisd/sads2/vk/market/services/db/hibernate-model-test.cfg.xml")
